...
class ScraperFloorplanClassifier:
    ...
    def move_image_if_floor_plan(self, file):
        ...
        new_file_name = f'{os.path.basename(file).split("__")[0]}_floorplan.jpg'
        floorplan_path = os.path.join(self.floor_plan_path, new_file_name)
        shutil.copy(file, floorplan_path)
